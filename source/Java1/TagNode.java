...
public class TagNode extends Node
{
  ...
  private Vector oNodeAttribs;    //Vector of Attribute objects.
  ...
  */
  ...
  /**
  * Returns attributes as Vector of Attribute objects.
  * @return The attributes as vector of Attribute objects.
  ...
  */
  public Attribute findAttribute(String sName)
  {
    ...
    for(Enumeration i=kAttribs.elements();i.hasMoreElements();)
    {
      Attribute attrib = (Attribute) i.nextElement();
  ...
  */
  public String getAttributesAsText()
  {
    if(sNodeAttribs == null)
    {
      ...
      Attribute oAttrib;
      Vector oAL = getAttributes();  //Important to call method because of lazy parsing!
      for(int i=0;i<oAL.size();i++)
      {
        oAttrib = (Attribute) oAL.elementAt(i);
  ...
  * Returns attributes as Vector of Attribute objects.
  */
  private Vector parseAttributes(String sAttribs) throws MalformedXMLException
  {
    Vector oAL = new Vector();
    ...
    Attribute oAttrib;  //Added to the vector.

...
public class Node implements Comparable
{
  ...
  */
  ...
  /**
  * Returns all the child nodes as an Vector object.  Order of XML document is preserved.
  ...
  */
  public Vector getChildNodes(long nFilter)
  {
    ...
    if(oNode != null)
    {
      ...
      while(oNode.oSibling != null)
      {
        ...
        {
          //We will output this one.
          oList.addElement(oNode.oSibling);
        }
